...
const TempBarChart = ({ sensorData, dateRange, selectedSensor }) => {
  ...
  if (!temperatureData || !temperatureData.readings?.length)
  ...
  const readings = useMemo(() => {
    ...
    return temperatureData.readings;
  }, [temperatureData.readings, isDateRangeSelected, dateRange]);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md h-[420px]">
      <div className="mb-4">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white">อุณหภูมิ</h2>
